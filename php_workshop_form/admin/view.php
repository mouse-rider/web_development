...
<div class="section-title">
    <h3>Staff list</h3>
        ...
        print '<h6 class= "successMessage">Student Deleted.</h6>';
				...
				$sql = "select * from work_shop_table";
				
				$table = mysqli_query($cn, $sql);
				
				
				print '<table>';
				print '<tr><th>ID</th><th>Staff Name</th><th>Gurdian Name</th><th>Contact</th><th>Email</th><th>Address</th><th>Class</th><th>Shift</th><th>Gender</th><th>Blood Group</th><th>Division</th><th>Action</th></tr>';
    ...
    function delete()
        {
            global $cn;
            $sql = "delete from work_shop_table where id = ".$_GET['did'];
            mysqli_query($cn, $sql);
        }
